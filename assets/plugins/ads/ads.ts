/* Interface que define el objeto para cada ad */
export interface Ad {
    imageUrl: string;
    title: string;
    body: string;
...
/* Array con todos los ads, que deben cumplir con las propiedades de la interface ad */
const ALL_ADS: Ad[] = [
    {
      imageUrl:
...
/* Se usaara un singleton, para asi evitar que se puedan crear duplicados de las publicidades y se meustren en disitintas partes de la pagina la misma publicidad */
class Ads{
    ...
    static getInstance(){
        ...
        // Ads.instance = Ads.instance || new Ads(); /* Una bonita solucion pero creo que sobreescribe en cada llamda a Ads.instance */


        return Ads.instance;
    }

    /* Se inicializan los ads, si no usara singleton, cada instancia de la clase iniciaria los mismos ads */
    private initAds(){
        this.ads = [...ALL_ADS]
        /* Se usa la desestructuracion de objetos para no alterar ALL_ADS, ya que de otro modo entrega su puntero a this.ads y se puede alterar */
    }
